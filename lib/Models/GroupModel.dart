class GroupModel {
  ...
  GroupModel.fromJson(Map<String, dynamic> json) {
    ...
    //   lastSeen = <Null>[];
    //   json['last_seen'].forEach((v) {
    //     lastSeen!.add(new Null.fromJson(v));
    //   });
    // }
  ...
  Map<String, dynamic> toJson() {
    ...
    //   data['last_seen'] = this.lastSeen!.map((v) => v.toJson()).toList();
    // }
...
class UserData {
  ...
  UserData.fromJson(Map<String, dynamic> json) {
    ...
    eLastNotif = json['e_last_notif'].toString().toString();
    ...
    permission = json['permission'].toString().toString();
...
class LastMessage {
  ...
  LastMessage.fromJson(Map<String, dynamic> json) {
    ...
    // if (json['read_receipts'] != null) {
    //   readReceipts = <Null>[];
    //   json['read_receipts'].forEach((v) {
  ...
  Map<String, dynamic> toJson() {
    ...
    //   data['read_receipts'] =
    //       this.readReceipts!.map((v) => v.toJson()).toList();
    // }
    if (this.userData != null) {
      data['user_data'] = this.userData!.toJson();
    }
...
class UserDataForGroup {
  ...
  UserDataForGroup.fromJson(Map<String, dynamic> json) {
    userId = json['user_id'].toString();
    username = json['username'].toString();
    email = json['email'].toString();
    firstName = json['first_name'].toString();
