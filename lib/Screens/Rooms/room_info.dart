...
class RoomsInformation extends StatefulWidget {
  const RoomsInformation({Key? key}) : super(key: key);

  @override
  _RoomsInformationState createState() => _RoomsInformationState();
}

class _RoomsInformationState extends State<RoomsInformation> {
  List imageList = [
            ...
            body: CustomScrollView(slivers: [
              SliverAppBar(
                ...
                flexibleSpace: FlexibleSpaceBar(
                  ...
                  title: Text('Future Discussion(Rooms)     ',style: TextStyle(fontSize: 18,fontFamily: AppFonts.segoeui),),
                  centerTitle: true,
